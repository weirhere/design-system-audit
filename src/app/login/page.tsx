      ...
      <div className="w-full max-w-sm space-y-6 text-center">
        <div className="space-y-2">
          <div className="flex justify-center">
            <svg width="40" height="40" viewBox="0 0 20 20" fill="none" className="text-indigo-600">
          ...
          <h1 className="text-2xl font-semibold text-slate-900">Design Audit</h1>
          <p className="text-sm text-slate-500">
            Sign in to manage your design system audits
          </p>
        </div>
        <button
          onClick={() => signIn('github', { callbackUrl: '/audits' })}
